...
"""
    ...
    def apply_filters(df, conditions):
        ...
        for col, op, val in conditions:
            col_matched = next((c for c in df.columns if c.lower().strip() == col.lower().strip()), None)

            if col_matched is None:
